...
import ru.nb.bds.core.presenter.design.component.RuniqueOutlinedActionButton
...
fun IntroScreen(
	...
	GradientBackground {
		...
		Column(
			...
			Text(
				text = stringResource(id = R.string.welcome_to_birthdays),
...
private fun RuniqueLogoVertical(
	...
	Column(
		...
		Text(
			text = stringResource(id = R.string.birthdays),
			fontSize = 24.sp,
